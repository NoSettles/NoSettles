...
$ptid = "";
$space = "";
$sql = "SELECT ptid FROM featured ORDER BY date DESC LIMIT 10";
...
$sql68 = "SELECT ptid FROM featured ORDER BY date DESC";
$query = mysqli_query($db_conx, $sql68);
$featured = mysqli_num_rows($query);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<main>
		<div class="parallax" style="padding-bottom: 0;">
            ...
            <h1 class="font-white narrow-font center-text">Featured Posts</h1>
            <p class="font-gray">
              <b>In case you were wondering:</b><br>
              This page shows the posts that NoSettles have picked as the best sources on the site. Keep in mind that these our only our opinion and vary from yours. We hope you find these posts interesting and enjoy them.
            </p>
